...
emo_tuples = [
    ('1f600', '😀', 1, 1, ':grinning:', [], 'people', []),
    ('1f603', '😃', 2, 1, ':smiley:', [], 'people', []),
    ('1f604', '😄', 3, 1, ':smile:', [], 'people', []),
    ('1f601', '😁', 4, 1, ':grin:', [], 'people', []),
    ('1f606', '😆', 5, 1, ':laughing:', [':satisfied:'], 'people', []),
    ('1f605', '😅', 6, 1, ':sweat_smile:', [], 'people', []),
    ('1f602', '😂', 7, 1, ':joy:', [], 'people', []),
    ('1f923', '🤣', 8, 1, ':rofl:', [':rolling_on_the_floor_laughing:'], 'people', []),
    ('263a', '☺', 9, 1, ':relaxed:', [], 'people', []),
    ('1f60a', '😊', 10, 1, ':blush:', [], 'people', []),
    ('1f607', '😇', 11, 1, ':innocent:', [], 'people', []),
    ('1f642', '🙂', 12, 1, ':slight_smile:', [':slightly_smiling_face:'], 'people', []),
    ('1f643', '🙃', 13, 1, ':upside_down:', [':upside_down_face:'], 'people', []),
    ('1f609', '😉', 14, 1, ':wink:', [], 'people', []),
    ('1f60c', '😌', 15, 1, ':relieved:', [], 'people', []),
    ('1f60d', '😍', 16, 1, ':heart_eyes:', [], 'people', []),
    ('1f618', '😘', 17, 1, ':kissing_heart:', [], 'people', []),
    ('1f617', '😗', 18, 1, ':kissing:', [], 'people', []),
    ('1f619', '😙', 19, 1, ':kissing_smiling_eyes:', [], 'people', []),
    ('1f61a', '😚', 20, 1, ':kissing_closed_eyes:', [], 'people', []),
    ('1f60b', '😋', 21, 1, ':yum:', [], 'people', []),
    ('1f61c', '😜', 22, 1, ':stuck_out_tongue_winking_eye:', [], 'people', []),
    ...
    ('1f440', '👀', 297, 1, ':eyes:', [], 'people', []),
    ('1f5e3', '🗣', 298, 1, ':speaking_head:', [':speaking_head_in_silhouette:'], 'people', []),
    ('1f464', '👤', 299, 1, ':bust_in_silhouette:', [], 'people', []),
    ('1f465', '👥', 300, 1, ':busts_in_silhouette:', [], 'people', []),
    ('1f476', '👶', 301, 1, ':baby:', [], 'people', []),
    ...
    ('1f46e', '👮', 391, 1, ':police_officer:', [':cop:'], 'people', []),
    ...
    ('1f37c', '🍼', 1242, 1, ':baby_bottle:', [], 'food', []),
    ('2615', '☕', 1243, 1, ':coffee:', [], 'food', []),
    ('1f375', '🍵', 1244, 1, ':tea:', [], 'food', []),
    ('1f376', '🍶', 1245, 1, ':sake:', [], 'food', []),
    ('1f37a', '🍺', 1246, 1, ':beer:', [], 'food', []),
    ('1f37b', '🍻', 1247, 1, ':beers:', [], 'food', []),
    ('1f942', '🥂', 1248, 1, ':champagne_glass:', [':clinking_glass:'], 'food', []),
    ('1f377', '🍷', 1249, 1, ':wine_glass:', [], 'food', []),
    ('1f943', '🥃', 1250, 1, ':tumbler_glass:', [':whisky:'], 'food', []),
    ('1f378', '🍸', 1251, 1, ':cocktail:', [], 'food', []),
    ('1f379', '🍹', 1252, 1, ':tropical_drink:', [], 'food', []),
    ('1f37e', '🍾', 1253, 1, ':champagne:', [':bottle_with_popping_cork:'], 'food', []),
    ('1f944', '🥄', 1254, 1, ':spoon:', [], 'food', []),
    ('1f374', '🍴', 1255, 1, ':fork_and_knife:', [], 'food', []),
    ('1f37d', '🍽', 1256, 1, ':fork_knife_plate:', [':fork_and_knife_with_plate:'], 'food', []),
    ('26bd', '⚽', 1257, 1, ':soccer:', [], 'activity', []),
    ('1f3c0', '🏀', 1258, 1, ':basketball:', [], 'activity', []),
    ('1f3c8', '🏈', 1259, 1, ':football:', [], 'activity', []),
    ('26be', '⚾', 1260, 1, ':baseball:', [], 'activity', []),
    ('1f3be', '🎾', 1261, 1, ':tennis:', [], 'activity', []),
    ('1f3d0', '🏐', 1262, 1, ':volleyball:', [], 'activity', []),
    ('1f3c9', '🏉', 1263, 1, ':rugby_football:', [], 'activity', []),
